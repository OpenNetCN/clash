...
- **2026-09-18：** 精简深度评测、新手教程、避坑指南与 FAQ 的正文篇幅，测速图与长测记录移至各机场网页版测评页；修复 FAQ 中缺失的问题标题与空条目。
- **2026-09-18：** 新增 GitHub 专区：全平台客户端下载表、Clash / Mihomo 配置模板、Nextin / Shadowrocket / sing-box / v2rayN 导入说明、线路与协议术语表；iOS 客户端推荐改为按机场是否接入 Nextin 判断；补充节点观测的检测方法说明。
- **2026-09-18：** 更新每日节点可用性观测数据。
- **2026-09-16：** 更新每日节点可用性观测数据。
- **2026-09-14：** 更新每日节点可用性观测数据。
- **2026-08-10：** 更新 WgetCloud 2026-08-10 解锁图与测速图。
- **2026-08：** 更新 WgetCloud 套餐与测速信息；唯兔云测速图更新为 2026-07-22 实测。
- **2026-07：** BoostNet / 悠兔测速图更新为 2026-07 实测。
- **2026-04：** 复盘 4 月机场集中打击，BoostNet / 悠兔 / WgetCloud 恢复能力最强；WgetCloud 临时只开放年付。
...
| 主要用 ChatGPT / Claude / Cursor | 免费机场 / 来路不明节点 | 综合主力看 BoostNet / 悠兔；专项出口看 TNTCloud |
...
- ✅ 对比过 **40+ 家** 主流机场，只保留当前仍值得按场景核对的精选名单
...
> 📌 **测试说明：** 不同地区、运营商、设备和时间段都会影响实际体验。已有长期样本的机场会按稳定性、适用范围、线路与出口、套餐门槛、客户端要求和售后响应综合评分；新加入且样本不足的机场暂不展示数字评分。购买前仍需核对结算页价格、官方公告和当前客户端要求。
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| [BoostNet](#boostnet) | 官方客户端 | 2026-09-18 | 可用 | 45 | 44 | 97.78% | 94.53% | 高 |
| [悠兔](#youtu) | 官方客户端 | 2026-09-18 | 可用 | 51 | 51 | 100.00% | 93.36% | 高 |
| [TNTCloud](#tnt) | 官方客户端 | 2026-09-18 | 可用 | 50 | 50 | 100.00% | 98.46% | 高 |
| [青云梯](#qingyunti) | 官方客户端 | 2026-09-18 | 可用 | 61 | 61 | 100.00% | 98.74% | 高 |
| [银河云](#yinheyun) | 官方客户端 | 2026-09-18 | 可用 | 34 | 34 | 100.00% | 97.96% | 高 |
| [唯兔云](#weituyun) | 官方客户端 | 2026-09-18 | 可用 | 73 | 73 | 100.00% | 92.83% | 高 |
| [WgetCloud](#wgetcloud) | Clash Verge | 2026-09-18 | 可用 | 29 | 29 | 100.00% | 100.00% | 高 |
...
> 💡 **想看更长的历史？** 这张表每次更新都会产生一次 commit，直接翻仓库提交记录就能看到任意一天的快照：
>
> ```bash
> # 查看这张表的全部历史版本
> git log --oneline -- README.md | grep -i "daily\|node"
>
> # 查看某次提交时的表格内容
> git show <commit>:README.md | sed -n '/每日节点可用性观测/,/^---$/p'
> ```
>
> 这是 GitHub 版独有的：网页版只能看到最新一天，仓库里能看到全部历史。
...
> 📌 **先判断你现在的情况：** 如果你现在还没有可用外网环境，下面这些链接可能打不开。建议先继续往下看 [新手教程](#study)，本页 README 已经包含完整主内容，不需要跳转。
>
...
| 机场 | 网页版测评入口 | 说明 |
| --- | --- | --- |
| BoostNet | [BoostNet 机场测评](https://gptvpnhelper.com/boostnet/) | 适合想单独查看 BoostNet 测速图、套餐和使用细节的人 |
| 悠兔 | [悠兔机场测评](https://gptvpnhelper.com/youtu/) | 适合重点比较 IEPL、晚高峰视频和长期主用体验的人 |
| 青云梯 | [青云梯机场测评](https://gptvpnhelper.com/qingyunti/) | 适合关注年付、省心、家庭多设备和长期稳定的人 |
| TNTCloud | [TNTCloud 机场测评](https://gptvpnhelper.com/tntcloud/) | 适合关注原生 / 高质量 IP、专项出口和 IDE 登录稳定性的人 |
...
- **机场**：自由度高，用户可根据自身需求在速度、价格、节点数量等方面灵活选择。机场专线延迟很低,对于有高质量网络需求的技术开发者、跨境电商卖家、内容创作者、流媒体重度用户来说，**机场往往是更优选**。
