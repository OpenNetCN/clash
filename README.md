...
本页面向寻找 **稳定机场、Clash机场、节点订阅与 AI 工具连接方案** 的用户，整理八家机场的购买门槛、客户端限制和配置方法。科学上网、魔法上网或梯子服务是否适合你，先看常用设备与目标平台，再比较价格。
...
先按主要用途锁定一家，再核对套餐和限制。下表按本文推荐顺序列出八家，各有侧重；已有主力时才按需补专项或备用。价格为本文资料记录，付款前核对当前结算金额。
...
| 多国家 / 家宽 IP / 多区域内容 | **TAG** | 历史记录：Special ¥162/年，全年共 200GB；主力 Bronze ¥185/季，250GB/月 | 历史资料支持官方及通用客户端；新疆、港澳台及境外不可用；不保证 TikTok 可用 | [看限制](#tag) · [查看套餐并注册](https://1028605.l49.net/#/auth/0XHcA2ji) |
...
> **先确认设备，再付款：** **WgetCloud、BoostNet、悠兔均支持 Clash 等通用客户端；BoostNet、悠兔也提供官方客户端。TAG 的历史资料记载支持官方及通用客户端，当前兼容名单与版本需按官网核对。青云梯、银河云、唯兔云、TNTCloud 当前只支持官方客户端。** 具体支持的系统、通用客户端名称与版本，以及安装或导入方式，请按对应官网说明操作。

🧭 [八家选购摘要](#top7) · [节点观测](#daily-check) · [新手上手](#study) · [购买前检查](#risk)
...
| BoostNet + TAG | 综合日常 | 按需补充家宽或冷门地区出口，先核对目标平台 |
| BoostNet + TNTCloud | 综合日常 | 按需验证 IDE 登录与专项出口 |
| 悠兔 + 银河云 | 高频视频与办公 | 年付轻量包做备用 |
| 青云梯 + 银河云 | 家庭多设备 | 第二家低流量备用 |
| 唯兔云 + TNTCloud | 多区域业务 | 补充目标地区或出口选择 |

优先用各家提供的短周期档测试。青云·诀、银河云轻量包和 TAG Special 本身仅年付；TAG Special 的 200GB 为全年总流量。若先买同品牌短周期档，需另行核对线路权限是否相同，不能把短周期测试视为对年付档的完整验证。
...
从 2022 年起长期自费订阅、对比过 40+ 家机场，目前保留八家。选择时关注常用设备兼容性、晚高峰连续使用、目标平台访问、付款条件和故障处理记录。
...
以下按摘要顺序列出已有观测快照：TAG 恢复自 Git 历史中的 2026-09-09 记录，其余为 2026-09-20 记录。日期不同，不用于同日横向排名，也不代表本次更新时重新检测。
...
| [TAG](#tag) | 官方客户端 | 2026-09-09（历史记录） | 304 | 301 | 99.01% |
...
### 4. 🌍 TAG 机场 — 多国家、家宽 IP 与冷门地区节点

**资料日期：** 套餐按 2026-08-24 历史资料恢复；客户端与使用限制沿用移除前的记录，本次未重新核实当前政策或结算价。

深港 IEPL · Shadowsocks · 家宽 / 原生 / 商宽落地 · 2018 年开业

- **适合谁：** 常用地区之外还需要冷门国家、家宽 IP、多区域流媒体内容，或希望为 AI 工具准备不同地区出口的人
- **不适合：** 人在新疆、港澳台或海外的用户；依赖 TikTok、传统邮件协议或受限 SSH 端口的用户应先确认限制
- **主要依据：** 历史公开套餐资料列出 330+ 条线路、100+ 国家和地区，并有官方客户端界面与 YouTube 4K 单次播放样本；这些记录不能证明当前规模、晚高峰或长期稳定性
- **核心参数：** Shadowsocks｜深港 IEPL 与多地区落地｜Special 5 台 / Bronze、Silver、Gold 10 台 / Team 同一区域 30 台｜支付宝 · 虚拟币；以当前面板和条款为准
- **客户端：** 历史资料记载同时支持官方客户端与通用客户端，建议先按官方客户端接入；需要 Clash 等通用工具时，付款前确认当前支持名单、版本与订阅格式
- **怎么买：** 轻量或备用看 **Special（记录价 ¥162/年，全年一次性 200GB）**；日常主力先看 **Bronze（记录价 ¥185/季，250GB/月）** ｜ 👉 [查看套餐并注册 TAG](https://1028605.l49.net/#/auth/0XHcA2ji)

| 套餐 | 历史记录价 | 流量 / 周期 | 设备限制 | 手动重置 |
| --- | ---: | --- | --- | ---: |
| Special | ¥162 / 年 | 200GB / 年，一次性发放 | 5 台 | ¥92 / 次 |
| **Bronze** | **¥185 / 季** | **250GB / 月** | 10 台 | ¥40 / 次 |
| Silver | ¥114 / 月 | 500GB / 月 | 10 台 | ¥87 / 次 |
| Gold | ¥219 / 月 | 999GB / 月 | 10 台 | ¥150 / 次 |
| Team | ¥658 / 月 | 3330GB / 月 | 同一区域 30 台 | ¥578 / 次 |
| 私人节点定制 | ¥1500+ / 月 | 默认 1TB / 月，可按需求增加 | 历史资料标注不限，需工单确认 | 咨询客服 |

> 🔄 **流量规则：** Special 的 200GB 是全年总量，**不是每月 200GB**。历史资料记载其他常规套餐按购买日每月重置；提前耗尽流量后，续费或重买同套餐不会立即重置，需另付重置费用。当前规则以面板为准。
>
> ⚠️ **购买前必看：** 常规服务仅限中国大陆，新疆、港澳台及海外不可用；这些地区需另询国际站服务。禁止分享订阅；屏蔽 SSH 22 端口及 10000–65535 高位端口，禁止 SMTP / POP3 / IMAP，历史说明称邮箱网页和官方 App 不受此项影响。**不保证 TikTok 可用**，也不保证大陆应用修改定位。家宽 IP 不等于私人独享住宅 IP；AI 与流媒体能否使用，需按具体节点、账号和平台验证，退款条件另查当前条款。

> 🔗 **查看套餐并注册：** [TAG 机场](https://1028605.l49.net/#/auth/0XHcA2ji)
> 💰 **价格口径：** 以上为 2026-08-24 历史套餐记录，当前可售套餐、手续费、重置费用与定制报价均以官网结算页或工单为准。

📖 历史节点界面、YouTube 播放样本与完整评测 → [TAG 机场测评](https://gptvpnhelper.com/tag/)

---

<a id="qingyunti"></a>

### 5. 🌤 青云梯 — 2019 年开业，IPLC 专线，轻量档 ¥96/年
...
### 6. 🔥 TNTCloud — 更看重原生 IP 与专线出口时可看，IPLC 专线，海外团队运营
...
### 7. 🐰 唯兔云 — 2025 新晋 IPLC 专线，SS2022 协议，TikTok / 电商 / 多区域业务专项可看
...
### 8. 🌌 银河云 Galaxy — ¥98/年轻量备用，Trojan / IEPL
...
- **主要依据：** 50GB/月的年付轻量档可作为第二家备用候选；按现有记录并非八家最低年付价，应结合本地表现选择
...
| **TAG** | Shadowsocks / 深港 IEPL | 历史记录：Special ¥162/年，全年共 200GB；Bronze ¥185/季，250GB/月 | 历史资料支持官方及通用客户端，当前版本需核对 | Special 5 台，常规档 10 台，Team 同一区域 30 台；禁止分享订阅；新疆、港澳台及境外不可用 |
...
“不限设备”不等于允许多人合租。青云梯与唯兔云另有不同门槛的轻量方案，银河云的定位是备用候选，不是全表最低价。TAG Special 的 200GB 为全年总流量，不能与每月重置的套餐直接按配额比较。
...
综合日常先看 [BoostNet](#boostnet) 的 200GB 月付档。需要 Clash 等通用客户端时，BoostNet、悠兔和 [WgetCloud](#wgetcloud) 都可选；偏高预算办公、能接受季付实付门槛时再重点看 WgetCloud；想先用月付验证 IEPL 与晚高峰视频表现，看 [悠兔](#youtu) 的 150GB 档，确认需求后再考虑 300GB 档。需要家宽 IP 或冷门地区节点时，再看排在悠兔之后的 [TAG](#tag)：轻量用量可比较 Special，主力用途先比较 Bronze 季付档。付款前先核对设备和地区限制。

### 2. 应该月付、季付还是年付？

第一次买建议先月付或季付。先验证你所在地区、运营商、常用设备和 ChatGPT / Claude / YouTube / Netflix 等场景都正常，再考虑长期套餐。TAG Special 仅年付，200GB 为全年一次性总量；若用其他档先测试，还需确认套餐间的线路权限。

### 3. ChatGPT / Claude / Cursor 选哪家？

综合主力先看 [BoostNet](#boostnet) 或 [WgetCloud](#wgetcloud)；更看重高端 IEPL 和晚高峰视频表现看 [悠兔](#youtu)；需要多地区、家宽或原生落地时看 [TAG](#tag)，先验证目标平台登录和连续会话；对原生或高质量出口、IDE 登录更敏感时补看 [TNTCloud](#tnt)。具体可用性以节点和平台风控为准。

配置上还有一点容易忽略：AI 工具的代理分组建议**手动固定节点**，不要用自动选择，频繁换 IP 更容易触发风控。写法见 [Clash 配置模板](#clash-config)。

### 4. TikTok / 跨境电商选哪家？

优先看 [唯兔云](#weituyun)，它更强调东南亚、印度、韩国及部分欧美节点覆盖，适合多区域业务和账号运营。需要更高质量专项出口时搭配 [TNTCloud](#tnt)。需要更多国家和地区时可核对 [TAG](#tag) 的覆盖，但其历史条款不保证 TikTok 可用，不把它作为 TikTok 功能保障。这类场景不要只看价格，先确认目标地区节点、账号登录地区和平台风控表现。

### 5. 官方客户端、Clash、Nextin 怎么选？

[WgetCloud](#wgetcloud)、[BoostNet](#boostnet)、[悠兔](#youtu) 均支持 Clash 等通用客户端，BoostNet 和悠兔也提供官方客户端。[TAG](#tag) 的历史资料记载支持官方及通用客户端，建议先按官方客户端接入，当前支持名单与版本需另行核对。青云梯、银河云、唯兔云、TNTCloud 当前只支持官方客户端。iOS 上若机场明确支持 Nextin，可按其识别码或订阅指引接入；App 免费下载、含内购，下载地区和功能费用另行核对。需要自定义规则时再确认订阅格式和客户端版本是否兼容，详见 [客户端配置与订阅](#config)。
